  ...
  if (method == "aipe") {
    ...
    text <- 
      glue::glue(
        ...
        We set the standard deviation of each group to {sigma}.Based on these parameters, a minimal sample size of {n1} was estimated in order \\
    ...
    text <- 
      glue::glue(
        ...
        parameters, a minimal sample size of {n1} was estimated to reach a {round(tpr_out, 2)} true positive rate for {effect} in our design.",
        thresh = output_parameters$thresh,
        n1 = output_parameters$n1,
        tpr_out = output_parameters$tpr_out,
        tpr = output_parameters$tpr,
    ...
    text <- 
      glue::glue(
        "We used a Interval Equivalent Bayes factor method (Morey & Rouder, 2011; Rouder et al., 2012, van Ravenzwaaij et al., 2019) to \\
        estimate the sample size. We used a Bayes factor threshold for evidence of {thresh}. We consider all effect sizes below {eq_band} \\
        ...
        each group to {sigma}. Based on these parameters, a minimal sample size of {n1} was estimated to reach a {round(tpr_out, 2)} true \\
    ...
    text <- 
      glue::glue(
        ...
        sizes below {eq_band} equivalent to zero,because {eq_band_justification}. We used a highest density interval of {ci}. We used a Cauchy prior \\
