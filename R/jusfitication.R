  ...
  if (method == "aipe") {
    ...
    text <-
      glue::glue(
        ...
        Equivalence (TOST; Schuirmann, 1981) method. We set the aimed TPR to be {tpr}, \\
    ...
    text <-
      glue::glue(
        ...
        (Morey & Rouder, 2011; van Ravenzwaaij et al., 2019) method. We set the aimed TPR at \\
    ...
    text <- 
      glue::glue(
        "We used a power analysis to estimate the sample size. We set the aimed power at {tpr}, because \\
