...
#' equivalence interval Bayes factor method. The
...
#'   by using the \code{\link{ssp_eq_bf}} function.
#' 
#' @format A dataframe with 33210 rows and 9 variables:
#' \describe{
...
#'   \item{eq_band}{numeric, The chosen width of the equivalence region.}
