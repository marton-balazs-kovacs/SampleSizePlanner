...
mod_home_ui <- function(id){
  tagList(
    div(
      ...
      estimation methods in the app and their relations. To get started with the sample size estimation
      ...
      p("*This version of the application is presented in a tutorial paper that is not reviewed.",
