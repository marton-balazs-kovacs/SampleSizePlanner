      ...
      sidebarPanel(
        ...
        sliderInput(
          ...
          name_with_info(
            ...
            "The desired long-run probability of obtaining a Bayes Factor at least as high than the threshold, given the input parameters"),
          min = 0.7,
          max = 0.9,
          value = 0.8,
          step = 0.05),
        ...
        sliderInput(
          ...
          name_with_info(
            "EQ Band",
            "The band width of the desired equivalence interval"),
          min = 0.1,
          max = 0.3,
          value = 0.2,
          step = 0.05),
