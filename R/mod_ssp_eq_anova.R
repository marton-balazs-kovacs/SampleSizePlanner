...
#' @title   mod_ssp_eq_anova_ui and mod_ssp_eq_anova_server
  ...
  tagList(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        # Method description
        p("A Bayesian statistical testing approach aimed at establishing equivalence between groups. The output shows results from pre-calculations."),
        ...
        sliderInput(
          ...
          name_with_info(
            ...
            "The desired long-run probability of obtaining a Bayes Factor higher than the threshold, given the means."),
          min = 0.7,
          max = 0.9,
          value = 0.8,
          step = 0.05),
        ...
        sliderInput(
          ...
          name_with_info(
            "EQ Band",
            "The margin of the standardized equivalence region"),
          min = 0.1,
          max = 0.3,
          value = 0.2,
          step = 0.05),
        ...
        selectInput(
          ...
          name_with_info(
            "Threshold",
            "The critical threshold of the Bayes factor."),
          choices = c(10),
          selected = 10),
        ## Input prior scale
        selectInput(
  ...
  moduleServer(id, function(input, output, session) {
    ...
    observeEvent(
      list(
        ...
        input$max_n, input$iter, input$thresh, input$prior_scale
      ), {
