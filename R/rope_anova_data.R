#' Region of Practical Equivalence (ROPE) method ANOVA Pre calculation Results
#' 
#' Data set that contains pre calculated sample sizes with the
#' ROPE method for 2*2 designs. The data set contains the input and output values of these calculations.
#' 
#' @section Remark:
