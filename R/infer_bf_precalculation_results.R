#' Non-inferiority Bayes Factor Precalculation Results
#' 
#' Dataset that contains precalculated sample sizes with the
#' non-inferiority Bayes factor method. The
...
#'   by using the \code{\link{ssp_infer_bf}} function.
#' 
#' @format A dataframe with 30690 rows and 9 variables:
#' \describe{
...
#'   \item{ni_margin}{non-negative numeric, The chosen non-inferiority margin.}
