...
The tutorial paper for two-group study designs can be found [HERE](https://journals.sagepub.com/doi/pdf/10.1177/25152459211054059).
...
print(citation("SampleSizePlanner"), style = "text")
```
...
```{r echo = FALSE, results = "asis"}
print(citation("SampleSizePlanner"), style = "Bibtex")
```
...
Kovacs, M., van Ravenzwaaij, D., Hoekstra, R., & Aczel, B. (2022). SampleSizePlanner: A tool to estimate and justify sample size for two-group studies. _Advances in Methods and Practices in Psychological Science, 5_(1), 25152459211054059.
