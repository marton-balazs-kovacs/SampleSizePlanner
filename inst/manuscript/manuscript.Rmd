...
# Sample Size Determination and Justification {.unnumbered}
...
## Choosing a method in case of sample size justification {.unnumbered}
...
## 1. Testing {.unnumbered}

### 1.1. Effect size = 0 {.unnumbered}

#### 1.1.1. Two One‐Sided Tests (TOST) {.unnumbered}
...
#### 1.1.2. Equivalence interval Bayes factor {.unnumbered}
...
### 1.2. Effect size \>0 {.unnumbered}

#### 1.2.1. Frequentist {.unnumbered}

##### 1.2.1.1. Classical power analysis {.unnumbered}
...
##### 1.2.1.2. Power curve {.unnumbered}
...
#### 1.2.2. Bayesian {.unnumbered}

##### 1.2.2.1. Predetermined sample size with Bayes factor {.unnumbered}
...
##### 1.2.2.2. Bayes Factor Design Analysis (BFDA) {.unnumbered}
...
## 2. Estimation {.unnumbered}

### 2.1. Frequentist {.unnumbered}

#### 2.1.1. Accuracy In Parameter Estimation (AIPE) {.unnumbered}
...
#### 2.1.2. A Priori Precision (APP) {.unnumbered}
...
### 2.2. Bayesian testimation {.unnumbered}

#### 2.2.1. Region of Practical Equivalence (ROPE) {.unnumbered}
